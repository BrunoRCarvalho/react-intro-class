    ...
    return (
      <div id="calculator-container">
        ...
        <div id="calculator-mask" className="remove-highlight">
          ...
          <div className="btn clear"   onClick={  () => { this.setResetDisplay(true); } }></div>
          ...
          <div className="btn multiply" onClick={ () => { this.setOperator('*'); this.setDisplay('*') } }></div>
          <div className="btn divide" onClick={ () => { this.setOperator('/'); this.setDisplay('/') } }></div>
          <div className="btn subtract" onClick={ () => { this.setOperator('-'); this.setDisplay('-') } }></div>
          <div className="btn add" onClick={ () => { this.setOperator('+'); this.setDisplay('+') } }></div>
        </div>
      </div>
    )
  }
